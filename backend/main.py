"""
ShopEngine 2 - Backend API
Multi-vendor marketplace with commissions and vendor dashboards
"""
...
app = FastAPI(
    title="ShopEngine 2",
    description="Multi-vendor marketplace with commissions and vendor dashboards",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "ShopEngine 2"}
